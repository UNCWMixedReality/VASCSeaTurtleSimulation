...
#pragma warning restore 414, 0649
    ...
    protected override void Start()
    {
        ...
        if (oculusCameraRig == null)
        {
            ...
            if (oculusCameraRig == null && ControlMethod == CUIControlMethod.OCULUSVR)Debug.LogError("OVRCameraRig prefab required. Import Oculus Utilities and drag OVRCameraRig prefab onto the scene.");           
        }
#endif
    }
