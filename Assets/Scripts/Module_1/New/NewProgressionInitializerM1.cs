...
public class NewProgressionInitializerM1 : MonoBehaviour
{
	...
	void Start()
	{
		...
		instrUpdater.instructions[13] = ("Correct! Now identify the next turtle");
		instrUpdater.instructions[14] = ("Correct! Now identify the third turtle");
		instrUpdater.instructions[15] = ("Correct! Now move to the waypoint to start the next activity");
